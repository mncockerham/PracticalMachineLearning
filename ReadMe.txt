...
2) Machine_learning_Course_Project.html which is the html page created by running the knitter on the RMD file, had trouble with the graph, the pdf has all images included.
